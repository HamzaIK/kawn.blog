...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
       ...
       <div className="blox lg:flex text-center items-center justify-center mb-8 w-full">
       ...
       <p className="text-center text-lg text-gary-700 font-normal px-4 lg:px-20 mb-8" dir="rtl" lang="ar">{post.excerpt}</p>
